...
public abstract class Move {
    ...
    public static class PawnPromotion extends Move {
        ...
        @Override
        public int hashCode() {
            return decoratedMove.hashCode() + (32 + promotedPawn.hashCode());
        }
        @Override
        public boolean equals(final Object other) {
    ...
    static abstract class CastleMove extends Move {
        ...
        public CastleMove(final Board board, final Piece movedPiece, final int destinationCoordinate,
                          final int castleRookDestination, final int castleRookStart, final Rook castleRook) {
            super(board, movedPiece, destinationCoordinate);
    ...
    public static final class KingSideCastleMove extends CastleMove {
        public KingSideCastleMove(final Board board, final Piece movedPiece, final int destinationCoordinate,
            ...
            super(board, movedPiece, destinationCoordinate, castleRookDestination, castleRookStart, castleRook);
        }
        @Override
        public boolean equals(final Object other) {
